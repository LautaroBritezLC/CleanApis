...
Route::middleware('validarbearer')->group(function () {
    ...
    // borrar usuario rol
    Route::put('seguridad/usuarios/rol',[UsuariosController::class, 'SPB_UsuarioRol']);
    ...
    //borrar tipo rol
    Route::put('seguridad/tiporoles',[tiporolController::class, 'SPB_TipoRol']);
    ...
    //borrar rol modulo
    Route::put('seguridad/rolmodulos',[rolModuloController::class, 'SPB_RolModulo']);
    ...
    Route::put('parametria/sucursales',[SucursalController::class, 'SPB_Sucursal']);
    ...
    //borrar Cliente
    Route::put('recursos/clientes',[ClienteController::class, 'SPB_Cliente']);
    ...
    //borrar Proveedor
    Route::put('recursos/proveedores',[ProveedorController::class, 'SPB_Proveedor']);
